...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "TME-RG-Workshop"   # mettre ici le nom du resource group de vos ressource
    storage_account_name = "tmeterraformstore" # mettre le nom du compte de stockage créer dans le lab 1
